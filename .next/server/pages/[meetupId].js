...
function MeetupDetail(props) {
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)("section", {
    className: (MeetupDetail_module_default()).text,
    children: [/*#__PURE__*/jsx_runtime_.jsx("img", {
      className: (MeetupDetail_module_default()).image,
      src: props.image,
      alt: props.title
...
async function getStaticPaths() {
  const client = await external_mongodb_.MongoClient.connect("mongodb+srv://practice:ttJdLhfxWde2x5BJ@cluster0.ibjf2.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
